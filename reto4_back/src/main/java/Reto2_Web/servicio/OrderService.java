...
//
    public List<Order> ordersSalesManByDate(String dateStr, int id) {
        return orderRepository.getByRegisterDayAndSalesManId(dateStr, id);
    }
//    
    public List<Order> ordersSalesManByState(Integer id, String state ) {
        return orderRepository.getBySalesManIdAndStatus(id, state);
    }

    public List<Order> ordersSalesManId(Integer id){
