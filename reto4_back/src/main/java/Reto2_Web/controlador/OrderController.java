...
public List<Order> getBySalesManId(@PathVariable("id") Integer id){
    return orderService.ordersSalesManId(id);
}
...
public List<Order> getByIdSalesManIdAndStatus(@PathVariable("id") Integer id,@PathVariable("status") String status){
    ...
    return orderService.ordersSalesManByState(id, status);
    }


@GetMapping("/date/{registerDay}/{id}")
public List<Order> getByRegisterDayAndSalesManId(@PathVariable("registerDay") String dateStr, @PathVariable("id") Integer id){
